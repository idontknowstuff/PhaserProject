class Duel extends Phaser.Scene {
    ...
    create(){
        ...
        this.block1 = this.add.image(575, 250, "blocks").setName("block1");
        this.block2 = this.add.image(575, 350, "blocks").setName("block2");
        this.block3 = this.add.image(575, 450, "blocks").setName("block3");
        this.block4 = this.add.image(575, 550, "blocks").setName("block4");
        ...
        this.zone1 = this.add.zone(200, 250, 300, 300).setRectangleDropZone(100, 50).setName("zone1");
        this.zone2 = this.add.zone(200, 350, 300, 400).setRectangleDropZone(100, 50).setName("zone2");
        this.zone3 = this.add.zone(200, 450, 300, 500).setRectangleDropZone(100, 50).setName("zone3");
        this.zone4 = this.add.zone(200, 550, 300, 600).setRectangleDropZone(100, 50).setName("zone4");
